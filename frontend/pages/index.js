          ...
          <div className="max-w-3xl w-full mx-auto grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-10">
            <div className="rounded-3xl bg-white/95 shadow-xl p-6 flex flex-col gap-4 border border-[#E8A46B]/20">
              ...
              <ul className="how-to-list space-y-4 text-[#4E342E] text-base font-inter">
                ...
                <li className="flex items-start gap-3"><span className="icon-tip">❓</span><span>Type <b>help</b> at any time for more tips.<br/><span className='block ml-7 mt-1 text-xs text-[#6B4F2B]'>All answers are generated by a secure, local mini-LLM trained on Nigerian food price data. No internet or cloud required.</span></span></li>
              </ul>
            </div>
          ...
          <div className="max-w-3xl w-full mx-auto bg-white/90 rounded-3xl shadow-2xl p-8 border border-[#E8A46B]/30">
            <div className="flex flex-col h-full">
              <div className="mb-6 text-center text-[#6B4F2B] font-lora text-lg md:text-xl bg-[#FFF7ED]/80 rounded-2xl px-4 py-3 shadow-sm">
                ...
                <span>ChopWise is now powered by a <b>local, state-of-the-art mini-LLM</b> for smarter, context-aware answers! Your last 3 messages and real Nigerian food price data are used for every reply. <b>No external API or cloud—your questions stay private.</b> <a href="#quickstart" className="underline hover:text-[#E8A46B] transition">See tips</a> for best results.</span>
              </div>
              {/* Messages List */}
              ...
              <form onSubmit={handleChatSubmit} className="flex gap-4 sticky bottom-0 bg-white/80 py-2 z-20" aria-label="Chat input form">
                <input
                  ...
                  placeholder="Type your question about Nigerian food prices... (e.g. 'cheapest rice in Abuja?')"
